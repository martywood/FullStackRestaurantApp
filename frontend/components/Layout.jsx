              ...
              <div className="hxl:block">
                {user ? (
                  ...
                  <div className="flex items-center justify-end">
                    ...
                    <Link
                      className="inline-block py-2 px-4 text-sm leading-5 text-green-50 bg-yellow-500 hover:bg-yellow-600 font-medium focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-md"
                      href="/register"
                    >
                      Sign Up
                    </Link>
